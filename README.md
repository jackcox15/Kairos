...
Reticulum is powerful, but deploying it for non-technical users is hard. Kairos strives to simplify the setup of LoRa radios, and organically build local resilient communication networks with minimum effort.
    ...
    • User Interface - MeshChat web UI instead of command line only 
